...
public final class SpriteControl {
    ...
    public boolean is1L2R(Sprite sprite1, Sprite sprite2) {
        RectF a = sprite1.getSpriteRectF();
        RectF b = sprite2.getSpriteRectF();
        return a.centerX() < b.centerX();
    }

    public boolean is1R2L(Sprite sprite1, Sprite sprite2) {
        RectF a = sprite1.getSpriteRectF();
        RectF b = sprite2.getSpriteRectF();
        return a.centerX() >= b.centerX();
    }

    public boolean is1T2B(Sprite sprite1, Sprite sprite2) {
        RectF a = sprite1.getSpriteRectF();
        RectF b = sprite2.getSpriteRectF();
        return a.centerY() < b.centerY();
    }

    public boolean is1B2T(Sprite sprite1, Sprite sprite2) {
        RectF a = sprite1.getSpriteRectF();
        RectF b = sprite2.getSpriteRectF();
        return a.centerY() >= b.centerY();
    }
